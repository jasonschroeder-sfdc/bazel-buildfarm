...
def archive_dependencies(third_party):
    return [
        ...
        },
        {
            ...
            "urls": [
                "https://mirror.bazel.build/github.com/bazelbuild/rules_pkg/releases/download/0.9.0/rules_pkg-0.9.1.tar.gz",
                "https://github.com/bazelbuild/rules_pkg/releases/download/0.9.0/rules_pkg-0.9.1.tar.gz",
            ],
        },
        {
            "name": "rules_license",
