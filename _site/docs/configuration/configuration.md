...
| runOperationQueuer               | boolean, _true_               |                 | Acquire execute request entries cooperatively from an arrival queue on the backplane. At least one instance of the server needs to run this.                                                     |
